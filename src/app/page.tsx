export default function Home() {
  ...
  const Rainbow = () => {
    return (<svg version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 1020 560"  >
      <g transform="scale(2.8,2.5) translate(-250,-320)"><path fill="#E0E9F6" d="M432,330.728c-77.292,0-139.836,62.543-139.836,139.836h77.705c0-34.416,27.786-62.131,62.131-62.131  c34.345,0,62.131,27.715,62.131,62.131h77.705C571.836,393.272,509.292,330.728,432,330.728z" />
        ...
        <path fill="#E0E9F6" d="M269.427,472.801c-19.888-18.988,13.355-37.844,27.659-20.111c12.506-18.931,47.823-14.388,53.199,8.623  c9.004-15.539,44.177-11.515,31.499,20.74c28.951,8.817,3.471,59.468-28.023,36.498c-8.921,22.698-67.744,17.712-73.958-5.136  C253.115,516.88,238.425,482.085,269.427,472.801z" />
      </g>
    </svg>)
  }
