...
export default function AboutMe() {
    return (
        <div className="box">
            ...
            <p className="has-text-weight-bold mt-4 p-2 pretty-border-black">"Renée is so so good at coding, plus she's just a lovely person to have around" -Robert C. Martin
