...
export default function AboutMe() {
    return (
        <section className="box">
            ...
            <p className="subtitle is-size-3 is-size-4-mobile has-text-color-dark-gray">I like making things</p>
            ...
            <br></br>
            <p>{`When it comes to coding, I really enjoy front-end work. I'm a user-centric engineer with a focus on accessibility and intuitive design.`}</p>
